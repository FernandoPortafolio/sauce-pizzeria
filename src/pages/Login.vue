    ...
    <div class="container-login100">
      <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
        <form class="login100-form validate-form flex-sb flex-w" @submit.prevent="login">
          <span class="login100-form-title p-b-32 text-center"> Login </span>

          <span class="txt1 p-b-11"> Nombre de Usuario </span>
          <div
          ...
          <div
            ...
            :class="{ 'alert-validate': v$.password.$error }"
            data-validate="Password is required"
          >
            <span class="btn-show-pass" @click="showingPass = !showingPass">
              <i class="fa" :class="showingPass ? 'fa-eye-slash' : 'fa-eye'"></i>
            </span>
            <input
              class="input100"
          ...
          <div class="container-login100-form-btn mt-4">
            <button class="login100-form-btn mx-auto w-100">Login</button>
          </div>
        </form>
      </div>
    </div>
